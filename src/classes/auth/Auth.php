...
SQL;
     ...
     * @throws AuthException
     */
    public static function register(string $email, string $mdpClair, string $mdpClair2): void {
        ...
        if ($res == 0) {
            // On vérifie ensuite si les deux mots de passe sont les mêmes (même si le script js doit aider l'utilisateur à le vérifier)
            if($mdpClair === $mdpClair2){
                ...
                throw new AuthException("<h3 id = \"error\">Les deux mots de passe entrés ne correspondent pas</h3>");
            }
